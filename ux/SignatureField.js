/*!
 *
 * I made some edits to this - celwell
 *
 *
 ...
 */
Ext.define('Ux.field.SignatureField', {
    ...
    setValue: function(value) {		
        var scale = 75 / this.getSigHeight();
        var scaledHeight = Math.floor(scale * this.getSigHeight());
        var scaledWidth = Math.floor(scale * this.getSigWidth());
        this.getComponent().setHtml('<img src="'+value+'" width="'+scaledWidth+'"  height="'+scaledHeight+'" />');
